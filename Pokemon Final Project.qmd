...
attack_stat_inline <- inline_text(pokemon_table, variable = "attack", column = "dragon", pattern = "{median}")
```
@tbl-one shows base stats stratified by primary typing. There were `r unique_pokemon_forms` Pokemon (including all forms and variants). Dragon and fighting types were tied for the highest median attack `r attack_stat_inline`.
